...
<div className='max-w-7xl mx-auto my-20 px-2'>
      <div className="mb-6 text-center">
        <h2 className="text-3xl project-title">Medwin Cares - Hospital Mangement system</h2>
      </div>
      ...
      <div className='lg:flex justify-center mb-2'>
        <div className='p-3'>
          <a target="_blank" href="https://github.com/xbayazid/medwin-cares-client" class="relative rounded px-5 py-2.5 overflow-hidden group bg-green-500 relative hover:bg-gradient-to-r hover:from-green-500 hover:to-green-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300">
            <span class="absolute right-0 w-8 h-32 -mt-12 transition-all duration-1000 transform translate-x-12 bg-white opacity-10 rotate-12 group-hover:-translate-x-40 ease"></span>
            <span class="relative">Client Code</span>
          </a>
        </div>
        <div className='p-3'>
        <a target="_blank" href="https://github.com/xbayazid/medwin-cares-server" class="relative rounded px-5 py-2.5 overflow-hidden group bg-green-500 relative hover:bg-gradient-to-r hover:from-green-500 hover:to-green-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300">
            <span class="absolute right-0 w-8 h-32 -mt-12 transition-all duration-1000 transform translate-x-12 bg-white opacity-10 rotate-12 group-hover:-translate-x-40 ease"></span>
            <span class="relative">Server Code</span>
          </a>
        </div>
        <div className='p-3'>
        <a target="_blank" href="https://medwin-cares-client.web.app/" class="relative rounded px-5 py-2.5 overflow-hidden group bg-green-500 relative hover:bg-gradient-to-r hover:from-green-500 hover:to-green-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300">
            <span class="absolute right-0 w-8 h-32 -mt-12 transition-all duration-1000 transform translate-x-12 bg-white opacity-10 rotate-12 group-hover:-translate-x-40 ease"></span>
