...
const About = () => {
    return (
        <div className='max-w-6xl mx-auto mt-32 px-6'>
            <h3 className="text-primary md:text-2xl text-lg font-normal">Hello, Myself</h3>
            ...
            <p className='md:w-1/2 text-justify'>I'm front-end developer specialized in <span className='text-primary'>React.js</span>. The main focus is front-end, but at the same time, I try to learn new technology also.</p>
            <div className='mt-10'>
